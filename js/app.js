$(document).ready(function () {
    ...
    // var url = "https://api.nasa.gov/planetary/apod?api_key=QKwS01YI5V3pU5eFj43T574QyeKOu2qxHvh4CI8N";

    // https://api.nasa.gov/EPIC/api/natural/images?api_key=QKwS01YI5V3pU5eFj43T574QyeKOu2qxHvh4CI8N


    // let url = "https://api.nasa.gov/EPIC/api/natural/images?api_key=QKwS01YI5V3pU5eFj43T574QyeKOu2qxHvh4CI8N"; 
...
//         //     $("#apod_img").attr("src", "../images/earth-min.jpg");
...
function spaceFloat(spaceDog) {
    ...
    spaceDog.animate({ top: newPosition[0], left: newPosition[1]}, speed, function() {
        spaceFloat(spaceDog); 
    }); 
